...
@pytest.mark.parametrize("testRun, init_selection, account_info, rest_selection, cust_selection, cart_selection, item, quantity, rest_name, reason, u_id, expected", [
    ...
    (True,"2", ["example@example.com","1234"], None, None, None, None, None, None, None, None, False),
    # Test 1: Check a failed test of Logging In by entering incorrect email
    (True,"2", ["exampleexample.com","1234"], None, None, None, None, None, None, None, None, False),
