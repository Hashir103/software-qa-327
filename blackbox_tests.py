...
@pytest.mark.parametrize("testRun, init_selection, account_info, rest_selection, cust_selection, cart_selection, item, quantity, rest_name, reason, u_id, expected", [
    ...
    (1,"2", ["example@example.com","1234"], None, None, None, None, None, None, None, None, False),
    # Test 1: Check a failed test of Logging In by entering incorrect email
    (1,"2", ["exampleexample.com","1234"], None, None, None, None, None, None, None, None, False),
    # Test 2: Checks if the program can successfully retrieve a Restaurant's menu correctly
    (1, "2", ["example@example.com","12345"], None, "2", None, None, None, "McDonalds", None, None, {'Big Mac': 5.99, 'McChicken': 4.99, 'McNuggets': 6.99}),
    # Test 3: Checks if the program can successfully retrieve all Restaurant's in our collection
    (1,"2", ["example@example.com","12345"], None, "1", None, None, None, None, None, None, True),
